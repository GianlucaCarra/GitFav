...
export class FavoritesView extends Favorites {
  ...
  onadd() {
    const addButtom = this.root.querySelector('#addButton');
    
    addButtom.addEventListener('click', () => {
      const { value } = this.root.querySelector('#input-name input');
  ...
  update() {
    ...
    this.entries.forEach( user  => {
      ...
      row.querySelector('.repositories').textContent = user.publilc_repos;
